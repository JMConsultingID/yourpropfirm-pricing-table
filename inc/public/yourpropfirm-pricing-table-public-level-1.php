<?php
/**
 * Plugin functions and definitions for Table Level 1.
 *
...
function yourpropfirm_pricing_table_level_1_shortcode($atts) {
    ...
    ob_start();
    ?>
    <div class="yourpropfirm-pricing-table-container yourpropfirm-pricing-table-pricing yourpropfirm-pricing-table-with-tab yourpropfirm-pricing-table-table-<?php echo $tab_mode; ?> category-<?php echo esc_attr($category_slugs_string); ?>">
                <?php
                if ($products): ?>
                    <div class="yourpropfirm-pricing-table-tab-buttons">
                        <?php foreach ($products as $productIndex => $product): ?>
                            <div class="yourpropfirm-pricing-table-tab-button <?php echo $productIndex == 0 ? 'active' : ''; ?>" data-tab-id="tab-<?php echo $product->get_id(); ?>">
                    ...
                    <?php foreach ($products as $productIndex => $product): ?>
                        <div id="tab-<?php echo $product->get_id(); ?>" class="yourpropfirm-pricing-table-tab-content product-<?php echo $product->get_slug(); ?> <?php echo $productIndex == 0 ? 'active' : ''; ?>" data-tab-id="tab-<?php echo $product->get_id(); ?>">
...
add_shortcode( 'yourpropfirm_table_level_1', 'yourpropfirm_pricing_table_level_1_shortcode' );